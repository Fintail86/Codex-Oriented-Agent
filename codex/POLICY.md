...
- `cosia_cli_command_lookup`: enabled, permission `read_only`, workspace `inside_only`
- `cosia_runtime_command`: enabled, permission `read_only`, workspace `inside_only`
