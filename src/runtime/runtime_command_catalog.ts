...
export const runtimeCommandDefinitions: RuntimeCommandDefinition[] = [
  ...
  command({ commandId: "gateway.telegram.webhook.status", cliDisplay: "cosia gateway telegram webhook status", argvTemplate: ["gateway", "telegram", "webhook", "status"], safety: "read_only", description: "Show Telegram Bot API webhook status for the connector.", ...readOnlyModelSurface, tags: ["gateway", "telegram", "텔레그램", "webhook", "웹훅", "status"] }),
  command({ commandId: "gateway.telegram.webhook.clear", cliDisplay: "cosia gateway telegram webhook clear --yes", argvTemplate: ["gateway", "telegram", "webhook", "clear"], safety: "system_boundary", description: "Disable the Telegram Bot API webhook so COSIA long polling can run.", tags: ["gateway", "telegram", "텔레그램", "webhook", "웹훅", "clear"], requiresApproval: true }),
